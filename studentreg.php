...
if (isset($_POST['register'])) {
	...
	$qry = "insert into student(name, gender, profile_imge, dob, emailid, password, address, phone, courseid, semester, status) values ('" . $_POST['name'] . "','" . $_POST['gender'] . "','" . $studentphotoPath . "','" . $_POST['dob'] . "','" . $_POST['emailid'] . "','" . $_POST['password'] . "','" . $_POST['address'] . "','" . $_POST['contactno'] . "','" . $_POST['courseid'] . "','" . $_POST['semester'] . "','Inactive')";

...
<div class="content">
	<div class="gallery">
		<div class="container">
			<?php
			$qry = mysqli_query($con, "select event_name from tblalumnimeet where eventid=" . $_GET['eventid']);
			$row = mysqli_fetch_array($qry);
			?>
			<h2><?php echo $row["event_name"] ?>'s Gallery</h2>
			...
			<div class="port-grid">
				...
				<div class="galley-1 animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">
					<div class='row'>
						<?php
						$c = 1;
						$qry = mysqli_query($con, "select * from tblgallery inner join tblalumnimeet on tblgallery.eventid=tblalumnimeet.eventid where tblgallery.eventid=" . $_GET['eventid']);

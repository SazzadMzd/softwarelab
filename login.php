	...
	if ($_POST["utype"] == "1") {
		...
		if (mysqli_num_rows($rs) > 0) {
			...
			if ($result['status'] == "Inactive") {
				...
				$sql = "SELECT * FROM tblalumniphoto JOIN tbluser ON tblalumniphoto.userid = tbluser.userid WHERE tbluser.userid = $result[0]";
				$result = mysqli_query($con, $sql);

				if (mysqli_num_rows($result) > 0) {
					$row = mysqli_fetch_assoc($result);
					if($row['profilepic'] != null){
						$_SESSION['profile_imge'] = $row['profilepic'];
					}
				}
		...
		if (mysqli_num_rows($rs) > 0) {
			...
			if ($result['status'] == "Inactive") {
				...
				$_SESSION['type'] = "staff";
				$_SESSION['uniqueID'] = $result['uniqueID'];
				$_SESSION['profile_imge'] = $result['staffphoto'];
				$_SESSION['user_logged_in'] = true;
		...
		if (mysqli_num_rows($rs) > 0) {
			...
			if ($result['status'] == "Inactive") {
				...
				$_SESSION['uniqueID'] = $result['uniqueID'];
				$_SESSION['profile_imge'] = $result['profile_imge'];
				$_SESSION['user_logged_in'] = true;
				echo "<script>window.location='index.php';</script>";
			}
		} else {
			...
			<form action="" method="post" class="form-horizontal">
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-8" style="text-align:center;">
						...
						<label for="inputEmail3" class="col-sm-7 control-label" style="text-align:left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="studentreg.php">New student?</a></label>
						<!-- <label for="inputEmail3" class="col-sm-3 control-label" style="text-align:left;"><a href="forgotpass.php">Forgot Password</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label> -->
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-8" style="text-align:center;">
